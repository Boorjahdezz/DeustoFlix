...
public class FormAgregarPelicula extends JDialog {
    ...
    public FormAgregarPelicula(VentanaAdmin parent) {
        super(parent, "Agregar Nueva Película", true);
        this.parent = parent;
        ...
        gbc.gridx = 1;
        gbc.weightx = 1.0;
        String[] categorias = {"Trending", "New Releases", "Popular", "Classic", "Award Winners"};
        ...
        gbc.gridx = 0;
        gbc.weightx = 0;
        panelForm.add(crearEtiqueta("Duración (min):"), gbc);
    ...
    private void guardarPelicula() {
        try {
            ...
            Pelicula pelicula = new Pelicula(titulo, descripcion, genero, cat, valoracion, duracion);
